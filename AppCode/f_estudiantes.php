...
<form action="r_tutores.php" method="post">
  ...
  <form action="r_tutores.php" method="post">
    ...
    <label for="pregunta5"><b>Pregunta 5</b>: Los estudiantes suelen trabajar solos en los proyectos del curso con poca supervisión por mi parte.</label><br>
    ...
    <label for="pregunta6"><b>Pregunta 6</b>: Compartir mi conocimiento y experiencia con los estudiantes es muy importante para mí.</label><br>
    ...
    <label for="pregunta7"><b>Pregunta 7</b>: Doy retroalimentación negativa a los estudiantes cuando su desempeño no es satisfactorio.</label><br>
    ...
    <label for="pregunta8"><b>Pregunta 8</b>: Las actividades en esta clase alientan a los estudiantes a desarrollar sus ideas sobre temas de contenido.</label><br>
    ...
    <label for="pregunta9"><b>Pregunta 9</b>: Dedico tiempo a consultar con los estudiantes sobre cómo mejorar su trabajo en proyectos individuales y grupales.</label><br>
    ...
    <label for="pregunta10"><b>Pregunta 10</b>: Las actividades en esta clase alientan a los estudiantes a desarrollar sus ideas sobre temas de contenido.</label><br>
    ...
    <label for="pregunta11"><b>Pregunta 11</b>: Lo que tengo que decir sobre un tema es esencial para que los estudiantes adquieran una perspectiva más amplia sobre los problemas de esa área.</label><br>
    ...
    <label for="pregunta12"><b>Pregunta 12</b>: Los estudiantes describirían mis estándares y expectativas como algo estrictos y rígidos.</label><br>
    ...
    <label for="pregunta13"><b>Pregunta 13</b>: Normalmente muestro a los estudiantes cómo y qué hacer para dominar el contenido del curso.</label><br>
    ...
    <label for="pregunta14"><b>Pregunta 14</b>: Las discusiones en grupos pequeños ayudan a los estudiantes a desarrollar su capacidad de pensar críticamente.</label><br>
    ...
    <label for="pregunta15"><b>Pregunta 15</b>: Los estudiantes diseñan una de las experiencias de aprendizaje más autodirigidas.</label><br>
    ...
    <label for="pregunta16"><b>Pregunta 16</b>: Quiero que los estudiantes dejen este curso bien preparados para seguir trabajando en esta área.</label><br>
    ...
    <label for="pregunta17"><b>Pregunta 17</b>: Soy responsable de definir lo que los estudiantes deben aprender y cómo deben aprenderlo.</label><br>
    ...
    <label for="pregunta18"><b>Pregunta 18</b>: Los ejemplos de mis experiencias personales a menudo ilustran puntos sobre el material.</label><br>
    ...
    <label for="pregunta19"><b>Pregunta 19</b>: Guío el trabajo de los estudiantes en los proyectos del curso haciéndoles preguntas, explorando opciones y sugiriendo formas alternativas.</label><br>
    ...
    <label for="pregunta20"><b>Pregunta 20</b>: Desarrollar la capacidad de los estudiantes para pensar y trabajar de forma independiente es un objetivo importante.</label><br>
    ...
    <label for="pregunta21"><b>Pregunta 21</b>: Dar conferencias es una parte importante de cómo enseño cada sesión de clase.</label><br>
    ...
    <label for="pregunta22"><b>Pregunta 22</b>: Proporciono pautas obvias sobre cómo quiero que se completen las tareas en este curso.</label><br>
    ...
    <label for="pregunta23"><b>Pregunta 23</b>: A menudo muestro a los estudiantes cómo pueden usar varios principios y conceptos.</label><br>
    ...
    <label for="pregunta24"><b>Pregunta 24</b>: Las actividades del curso alientan a los estudiantes a tomar la iniciativa y la responsabilidad de su aprendizaje.</label><br>
    ...
    <label for="pregunta25"><b>Pregunta 25</b>: Los estudiantes asumen la responsabilidad de impartir parte de las sesiones de clase.</label><br>
    ...
    <label for="pregunta26"><b>Pregunta 26</b>: Mi experiencia generalmente se usa para resolver desacuerdos sobre problemas de contenido.</label><br>
    ...
    <label for="pregunta27"><b>Pregunta 27</b>: Este curso tiene metas y objetivos concretos que quiero lograr.</label><br>
    ...
    <label for="pregunta28"><b>Pregunta 28</b>: Los estudiantes reciben frecuentes comentarios verbales y escritos sobre su desempeño.</label><br>
    ...
    <label for="pregunta29"><b>Pregunta 29</b>: Solicito el consejo de los estudiantes sobre cómo y qué enseñar en este curso.</label><br>
    ...
    <label for="pregunta30"><b>Pregunta 30</b>: Los estudiantes establecen su propio ritmo para completar proyectos independientes y grupales.</label><br>
    ...
    <label for="pregunta31"><b>Pregunta 31</b>: Los estudiantes pueden describirme como un "almacén de conocimiento" que proporciona los hechos, principios y conceptos que necesitan.</label><br>
    ...
    <label for="pregunta32"><b>Pregunta 32</b>: El plan de estudios define claramente mis expectativas sobre lo que quiero que hagan los estudiantes en esta clase.</label><br>
    ...
    <label for="pregunta33"><b>Pregunta 33</b>: Eventualmente, muchos estudiantes comenzaron a pensar como yo sobre el contenido del curso.</label><br>
    ...
    <label for="pregunta34"><b>Pregunta 34</b>: Los estudiantes pueden elegir entre actividades para completar los requisitos del curso.</label><br>
    ...
    <label for="pregunta35"><b>Pregunta 35</b>: Mi enfoque de la enseñanza es similar al de un gerente de un grupo de trabajo que delega tareas y responsabilidades a sus subordinados.</label><br>
    ...
    <label for="pregunta36"><b>Pregunta 36</b>: Este curso tiene más material del que tengo tiempo disponible para cubrir.</label><br>
    ...
    <label for="pregunta37"><b>Pregunta 37</b>: Mis estándares y expectativas ayudan a los estudiantes a desarrollar la disciplina que necesitan aprender.</label><br>
    ...
    <label for="pregunta38"><b>Pregunta 38</b>: Los estudiantes pueden describirme como un "entrenador" que trabaja en estrecha colaboración con alguien para corregir problemas en su forma de pensar y comportarse.</label><br>
    ...
    <label for="pregunta39"><b>Pregunta 39</b>: Doy a los estudiantes mucho apoyo personal y aliento para que les vaya bien en este curso.</label><br>
    ...
    <label for="pregunta40"><b>Pregunta 40</b>: Asumo el papel de una persona de recursos disponible para los estudiantes cuando necesitan ayuda.</label><br>
